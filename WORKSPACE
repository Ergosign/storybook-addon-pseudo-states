...
workspace(
    ...
    name = "ergosign_storybook_pseudo_states",
...
## not used
# Bazel to also install a node_modules in your workspace you can also point the node_repositories repository rule in your WORKSPACE file to your package.json
